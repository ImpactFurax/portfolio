...
export const projects = [
  ...
  { id: '3', title: 'DragonStory', techno: ['NextJs', 'ReactJs', 'TailwindCSS', 'MongoDB'], description: 'Discordia est un site qui permet aux utilisateurs de créer des fils de discussion d\'horreur en utilisant une image de leur choix comme point de départ.', screen: "screen_project3.png", img: 'project3_image1.png', carroussel: ['project1_image1.png'], url: '', finish: false },
  { id: '4', title: 'CookAndClick', techno: ['React Native', 'TailwindCSS', 'MongoDB', 'Expo'], description: 'Discordia est un site qui permet aux utilisateurs de créer des fils de discussion d\'horreur en utilisant une image de leur choix comme point de départ.', screen: "screen_project4.png", img: 'project4_image1.png', carroussel: ['project1_image1.png', 'project1_image2.png', 'project1_image3.png'], url: '', finish: false },
] 